/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a816971374c3b5180bc6739f1b7290ab)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GEMINI_API_KEY: "<set-in-prod-or-use-secret>";
		MYBROWSER: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MY_VAR" | "GEMINI_API_KEY">> {}
}
